...
class RAGWire:
    ...
    def _extract_filters_from_query(self, query: str) -> Optional[Dict[str, Any]]:
        ...
        prompt_template = (
            ...
            "2. Always extract the value the user asked for — even if it does not appear in the stored values below.\n"
            "   Stored values are a format reference, not a whitelist. Never omit a field just because its value is missing from the stored list.\n"
